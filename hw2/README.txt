Total Hours Spent: 5.0, due to VM issues
...
entry point: as reported by readelf - "entry point address: 0xC5"
...
2. Optional: binwalk, objdump, nm to Analysis binaries files
   http://binwalk.org/
